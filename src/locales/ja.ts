export default {
  ...
  hero: {
    slides: {
      1: {
        title: "グローバルクロスボーダーECプラットフォーム",
        subtitle: "世界中のバイヤーとセラーをつなぎ、越境ECの旅を始めましょう",
      },
      2: {
        title: "スマート物流ソリューション",
        subtitle: "グローバル物流追跡で、安全な配送を確保",
      },
      3: {
        title: "ワンストップショップ管理",
        subtitle: "使いやすいバックエンドシステムで、ビジネスを簡単に管理",
      },
    },
    registerTitle: "出品者登録",
    registerSubtitle: "グローバルECプラットフォームに参加",
    email: "メールアドレス",
  ...
  features: {
    title: "選ばれる理由",
    subtitle: "包括的な越境ECソリューションを提供",
    items: {
      1: {
        title: "グローバル市場カバレッジ",
        description: "200以上の国と地域をカバーし、世界中のバイヤーにリーチ"
      },
      2: {
        title: "スマート物流",
        description: "マルチチャネル物流ソリューションとリアルタイム追跡"
      },
      3: {
        title: "多言語サポート",
        description: "グローバルコミュニケーションのための多言語インターフェース"
      },
      4: {
        title: "安全な決済",
        description: "セキュリティ保証付きの複数の決済方法"
      }
    }
  },
  testimonials: {
    title: "お客様の声",
    subtitle: "グローバルセラーからの実際のフィードバック",
    items: {
      1: {
        content: "このプラットフォームを通じて、当社の製品は米国と欧州市場に成功裏に参入し、売上が300%増加しました。",
        author: "張さん",
        role: "電子機器販売"
      },
      2: {
        content: "プラットフォームの物流システムは非常に信頼性が高く、越境物流の効率が大幅に向上しました。",
        author: "リーさん",
        role: "ファッションブランドオーナー"
      },
      3: {
        content: "多言語サポートにより、海外のお客様とのコミュニケーションが容易になり、成約率が大幅に向上しました。",
        author: "王さん",
        role: "ホームグッズ販売"
      }
    }
  ...
  registrationSteps: {
    title: "4ステップで出店開始",
    subtitle: "シンプルで迅速な出店プロセス、専門サポートチームがサポートします",
    steps: {
      1: {
        number: "01",
        title: "アカウント登録",
        description: "基本情報を入力し、越境ECアカウントを作成",
        details: [
          "企業/個人メールアドレス",
          "連絡先電話番号",
          "基本情報"
      ...
      2: {
        number: "02",
        title: "資格認証",
        description: "必要な資格書類をアップロードして認証",
        details: [
          "営業許可証",
          "代表者身分証明書",
          "銀行口座証明書",
      ...
      4: {
        number: "04",
        title: "研修認定",
        description: "プラットフォーム出店者研修を受講し、認定を取得",
        details: [
          "プラットフォームルール学習",
          "システム操作研修",
          "オンライン認定テスト"
